...
class CourseDetailsPopup(tk.Toplevel):
    ...
    # Get the course directory path
        ...
        course_directory = os.path.join("COURSE_BACKBONE", course_name)  # Correct path to the course directory

        # Call calculate_course_grade with the correct directory path
        course_grade = calculate_course_grade(course_name, course_directory)  # Provide course_directory argument

        # Display the course grade
        messagebox.showinfo("Course Grade", f"The calculated grade for {course_name} is {course_grade}%.")
