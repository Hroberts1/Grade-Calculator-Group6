...
def create_add_assignment_popup(course):
    ...
    def submit_assignment():
        ...
        assignments_db = sqlite3.connect(os.path.join(course['course_name'].replace(' ', '_'), f"{course['course_name'].replace(' ', '_')}_assignments.db"))
...
def view_assignments(course):
    ...
    for assignment in assignments:
        assignments_tree.insert("", "end", values=(assignment[1], assignment[2], assignment[3]))  # Inserting assignment values
