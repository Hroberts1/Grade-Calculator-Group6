...
style = ttk.Style()
style.configure('TButton', relief=tk.RAISED, borderwidth=3, foreground='black', background='lightgray', font=('Arial', 10), anchor='center', borderradius=10)
style.map('TButton', background=[('active', '!disabled', 'gray')])
